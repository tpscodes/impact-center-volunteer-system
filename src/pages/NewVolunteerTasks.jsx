      ...
      <header style={{ background: 'linear-gradient(144.76deg, #0f7a70 14.286%, #0a2a3a 85.714%)', padding: '20px 20px 24px', borderRadius: '0 0 24px 24px', display: 'flex', flexDirection: 'column', gap: 16, flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex' }}>
          {[
            ...
            <div key={label} style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 2, padding: i === 0 ? '0 16px 0 0' : i === arr.length - 1 ? '0 0 0 16px' : '0 16px 0 16px', borderRight: i < arr.length - 1 ? '1px solid rgba(255,255,255,0.18)' : 'none' }}>
